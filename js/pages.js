			...
			<div class="container">
				<div class="menu">
					<div class="outer selected" id="outer-about" down="outer-themes" onclick="touched(this.id)">
						<div class="inner" id="about" onclick="settingsTab(this.id)">&nbsp;&nbsp;Sobre
						</div>
					</div>
					<hr>
					<div class="outer" id="outer-themes" up="outer-about" down="outer-notifications" onclick="touched(this.id)">
						<div class="inner" id="themes" onclick="settingsTab(this.id)">&nbsp;&nbsp;Temas
						</div>
					
					</div>
					<hr>
					<div class="outer" id="outer-system" up="outer-notifications" onclick="touched(this.id)">
						<div class="inner" id="system" onclick="settingsTab(this.id)">&nbsp;&nbsp;Información del Sistema
						</div>
					</div>
				</div>
...
var newUserHTML2 = `<div class="container" id="new-user-page">
				<input class="selected" tabindex="-1" id="next-button" down="reuse" type="submit" onclick="NUNext()" value="Siguiente">
				<img class="new-user-image" src="images/users.png">
				<div id="info">Selecciona tu nombre e icono de usuario.<br><div class="additional-information"></div></div>
				<a id="reuse" up="next-button" onclick="alreadyUser()">¿Ya tienes una cuenta?</a>
			</div>`;

var newUserHTML = `<div class="nav" style="height: 80px;">Usuario Nuevo<span class="next" right="next-button" down="next-button" left="next-button" up="next-button"></span><span class="return-to" returnto=""></span>
			</div>`+newUserHTML2;
...
var newUserHTML3 = `<div style="display: block;">
		<div id="select">
			...
			<br>
			<div class="change">
				Podras cambiarlo en otro momento.
			</div>
		</div>
		<div id="icon-selection">`+prepIcons()+`
		</div>
		<input tabindex="-1" id="create-own" onclick="createIcon()" type="submit" value="Crear icono" up="new-icon7">
	</div>`;
...
var leftSideCreateHTML = `<div class="edit-icon-button selected" id="character-button" 	down="background" onclick="selectCharacter('create')">
		<span>Personaje</span> <img height="60" id="edit-character">
	</div>
	<div class="edit-icon-button" id="background" up="character-button" down="icon-ok" onclick="selectBG('create')"><span>Fondo</span> <div class="bg-color"></div></div>
...
function loadCustomLinks() {
	...
	customLinksHTML = `<div class="link-wrap">
		<div class="link custom-link" id="custom-1" left="outer-links" down="custom-4" right="custom-2"><a tabindex="-1">Añadir</a></div>
		<div class="link custom-link" id="custom-2" left="custom-1" down="custom-5" right="custom-3"><a tabindex="-1">Añadir</a></div>
		<div class="link custom-link" id="custom-3" left="custom-2" down="custom-6"><a tabindex="-1">Añadir</a></div>
		<div class="link custom-link" id="custom-4" left="outer-links" up="custom-1" right="custom-5" down="custom-7"><a tabindex="-1">Añadir</a></div> 
		<div class="link custom-link" id="custom-5" left="custom-4" up="custom-2" right="custom-6" down="custom-8"><a tabindex="-1">Añadir</a></div> 
		<div class="link custom-link" id="custom-6" left="custom-5" up="custom-3" down="custom-9"><a tabindex="-1">Añadir</a></div>
	</div>`;

...
function settingsTab(tab) {
	...
	switch(tab) {
		case "about": // About tab
			settingsPageContent = `<h2>Sobre Web Browser</h2>
				Web Browser es un proyecto de D3fau4 que permite usar con facilidad en navegador por defecto de la Nintendo Switch, este usa los servicios de <a href="https://developers.google.com/speed/public-dns/" tabindex="-1" id="bru-web" left="outer-about" down="patreon">SwitchBru</a>.
				<br><br>
				<h2>Sobre SwitchBru</h2>
				This service is provided free of charge. We do not store or retain any personal web browsing data. Besides providing the initial redirect for the Nintendo Switch, all DNS queries are handled via <a href="https://fortheusers.org/" tabindex="-1" id="google-dns" left="outer-about" down="patreon">Google DNS</a>.
                <br><br>
				...
				<br><hr>
				<small><b>v4.3.0</b> &ndash; created by vgmoose, designed by pwsincd, with news, user features and messaging added by <a href="https://www.patreon.com/ep8script" id="patreon" tabindex="-1" left="outer-about" up="google-dns">Ep8Script</small><span class="select-next" selectnext="google-dns"></span>`
		...
		case "system": // System tab
			settingsPageContent = `<div class="system-page">
				<input type="submit" id="check-update" value="Comprobar Actualizacion" onclick="checkUpdate()" left="outer-system" down="console-name" tabindex="-1">
				<span class="version-string">
					Version actual del sistema: <span class="version"></span>
				</span>
				...
				<select class="display-colors">
					...
					<option value="greyscale">Escala de Grises</option>
				</select>
				<div class="system-buttons" id="display-colors" up="console-name" left="outer-system" down="send-error-info">
					<span>Cambiar los colores en pantalla</span> <span class="display-color text-right">Defecto</span>
				</div>
				
				<div class="system-buttons" id="disable-ads" up="send-error-info" left="outer-system">
					<span>AdBlock</span> <span class="disable-ads text-right disabled">Off</span>
				</div>
